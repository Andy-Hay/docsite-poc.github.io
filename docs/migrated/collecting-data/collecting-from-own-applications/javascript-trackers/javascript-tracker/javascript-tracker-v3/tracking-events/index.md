...
For more information on custom context, see [here](/docs/migrated/understanding-tracking-design/predefined-vs-custom-entities/).
...
Further information about the event payload can be found in the [tracker protocol documentation](/docs/migrated/collecting-data/collecting-from-own-applications/snowplow-tracker-protocol/).
...
`trackSocialInteraction` can also be passed an array of custom context as an additional parameter. See [custom context](/docs/migrated/collecting-data/collecting-from-own-applications/javascript-tracker/tracking-specific-events/#custom-contexts) for more information.
