...
- Feature improvement
- Bugfixes
- [Creating a new tracker](/docs/migrated/contributing/tracker-specification-for-contribution/)
- [Creating a new webhook](/docs/migrated/contributing/webhook-specification-for-contribution/)
...
Please complete and sign the most appropriate CLA for you. For more information, see our dedicated page on our [Contributor License Agreements](/docs/migrated/contributing/contributor-license-agreement/).
